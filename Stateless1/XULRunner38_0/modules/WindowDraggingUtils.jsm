...
//@line 10 "d:\mozilla\release\toolkit\modules\WindowDraggingUtils.jsm"
...
//@line 17 "d:\mozilla\release\toolkit\modules\WindowDraggingUtils.jsm"
  if (!this.isPanel())
    this._elem.addEventListener("MozMouseHittest", this, false);
  else
//@line 21 "d:\mozilla\release\toolkit\modules\WindowDraggingUtils.jsm"
...
//@line 64 "d:\mozilla\release\toolkit\modules\WindowDraggingUtils.jsm"
    if (!isPanel) {
      if (this.shouldDrag(aEvent))
        aEvent.preventDefault();
      return;
    }
//@line 70 "d:\mozilla\release\toolkit\modules\WindowDraggingUtils.jsm"
...
//@line 81 "d:\mozilla\release\toolkit\modules\WindowDraggingUtils.jsm"
        if (isPanel) {
...
//@line 94 "d:\mozilla\release\toolkit\modules\WindowDraggingUtils.jsm"
        break;
      case "mousemove":
